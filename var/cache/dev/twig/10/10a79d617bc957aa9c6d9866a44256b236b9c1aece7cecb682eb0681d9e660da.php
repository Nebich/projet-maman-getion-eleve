...
class __TwigTemplate_380ca6bbbcf148538170f69dea82802f7e5cdb692deb9a0ca07ee69969aa24fb extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            ...
            echo "</td>
                <td>
                    <a href=\"";
            // line 21
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("group_show", ["id" => twig_get_attribute($this->env, $this->source, $context["group"], "id", [], "any", false, false, false, 21)]), "html", null, true);
            echo "\">Voir</a>
                    <a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("group_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["group"], "id", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\">Modifier</a>
                </td>
                <td>
                    ";
...
";
    ...
    {
        return array (  168 => 36,  163 => 33,  154 => 29,  137 => 25,  131 => 22,  127 => 21,  122 => 19,  119 => 18,  101 => 17,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
        ...
        {% for group in groups %}
            <tr>
                ...
                <td>
                    ...
                    <a href=\"{{ path('group_edit', {'id': group.id}) }}\">Modifier</a>
                </td>
                <td>
    ...
    <a href=\"{{ path('group_new') }}\">Ajouter une classe</a>
{% endblock %}
