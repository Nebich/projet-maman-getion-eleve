...
class __TwigTemplate_75705c41b7912e71ddd180591d627db9ec22f7b5e7420590c6e60861eacc9f34 extends Template
{
    private $source;
    private $macros = [];
    ...
    <input type=\"hidden\" name=\"_token\" value=\"";
        ...
        echo "\">
    <button class=\"btn btn-danger btn-sm\"><i class=\"bi bi-trash-fill\"></i> Supprimer</button>
</form>
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn btn-danger btn-sm\"><i class=\"bi bi-trash-fill\"></i> Supprimer</button>
</form>
", "user/_delete_form.html.twig", "C:\\Users\\Utilisateur\\Desktop\\projet-maman-getion-eleve\\templates\\user\\_delete_form.html.twig");
    }
}
