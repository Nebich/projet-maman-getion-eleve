...
class __TwigTemplate_273a45f2f1b8fc50d6c6a69a7a1ff7050d8bbaea85efb73f8725b1803eee00f9 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {{ form_widget(form) }}
    <div class=\"btn-group mt-3\">
        <a href=\"{{ path('user_index') }}\" class=\"btn btn-danger\"><i class=\"bi bi-arrow-left\"></i>Retour</a>
        <button class=\"btn btn-primary\">{{ button_label|default('Enregistrer') }}</button>
    </div>
{{ form_end(form) }}
", "user/_form.html.twig", "C:\\Users\\Utilisateur\\Desktop\\projet-maman-getion-eleve\\templates\\user\\_form.html.twig");
    }
}
